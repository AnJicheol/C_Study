...
function solution(queue1, queue2) {
    ...
    var max = queue1.length*4
    var count1 = 0;
    var count2 = 0;
    while(answer<max){
        
        if(result1 == result2) return answer
        
        if(result1 > result2){
           queue2[queue2.length] = queue1[count1]
           result2 += queue1[count1]
           result1 -= queue1[count1]
           count1++
           answer++
        }
        if(result1 < result2){
           queue1[queue1.length] = queue2[count2]
           result1 += queue2[count2]
           result2 -= queue2[count2]
           count2++
           answer++
        }
    }
